...
(function (factory) {
    ...
    var disableSelection = $.fn.extend({
        disableSelection: (function () {
            ...
            return function () {
                return this.on(eventType + ".ui-disableSelection", function (
                    event
                ) {
    ...
    var effectsEffectScale = $.effects.define("scale", function (
        options,
        done
    ) {
        // Create element
    ...
    var effectsEffectShake = $.effects.define("shake", function (
        options,
        done
    ) {
        var i = 1,
        ...
        _move: function (direction, filter, event) {
            ...
            if (this.active) {
                if (direction === "first" || direction === "last") {
                    ...
                    next = this.active[direction + "All"](".ui-menu-item").eq(
                        0
                    );
                }
            }
    ...
    var widgetsSelectmenu = $.widget("ui.selectmenu", [
        $.ui.formResetMixin,
        {
            ...
            _move: function (direction, event) {
                ...
                if (direction === "first" || direction === "last") {
                    next = item[direction === "first" ? "prevAll" : "nextAll"](
                        filter
                    ).eq(-1);
                } else {
            ...
            if ($.isArray(options.disabled)) {
                options.disabled = $.unique(
                    options.disabled.concat(
                        $.map(this.tabs.filter(".ui-state-disabled"), function (
                            li
                        ) {
